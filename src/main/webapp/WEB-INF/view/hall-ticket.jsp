...
<body>
	...
	<form:form action="save-hallTicket" modelAttribute="hallTicket" method="POST" enctype="multipart/form-data">
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td colspan="2" width="100px" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="${file.path}/${file.name}" alt="mohit" style="border: 1px solid #555555;width:200px;height:260px;max-height:100%; max-width:100%;margin-left: auto;margin-right: auto;"/></td>
                </tr>
                <tr>
